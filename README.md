...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dp1
```

A live public deployment of this template is available at [https://dp1.templates.workers.dev](https://dp1.templates.workers.dev)
